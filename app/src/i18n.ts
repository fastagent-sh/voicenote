...
export const ZH: Record<string, string> = {
  ...
  "Re-sign in to ChatGPT": "重新登录 ChatGPT",
  ...
  "Provider": "服务商",
  "ChatGPT with OpenAI API fallback": "ChatGPT（OpenAI API 备用）",
  "ChatGPT": "ChatGPT",
  ...
  "Checking…": "检查中…",
  "Connected": "已连接",
  "Credentials configured": "凭证已配置",
  "Credentials unavailable": "凭证不可用",
  "Could not check credentials": "凭证检查未完成",
  "Summary model": "纪要模型",
  "Transcription": "转写",
  "Configured · {0}": "已配置 · {0}",
  "Not configured": "未配置",
